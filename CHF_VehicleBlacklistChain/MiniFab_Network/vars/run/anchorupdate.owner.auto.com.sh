...
jq '.channel_group.groups.Application.groups."owner-auto-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.126.192","port": 7003}]},"version": "0"}}' autochannel_current_config.json > autochannel_modified_anchor_config.json
