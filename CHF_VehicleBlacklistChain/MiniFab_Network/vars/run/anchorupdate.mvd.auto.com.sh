...
export CORE_PEER_ADDRESS=192.168.126.192:7005
export CORE_PEER_TLS_ROOTCERT_FILE=/vars/keyfiles/peerOrganizations/mvd.auto.com/peers/peer1.mvd.auto.com/tls/ca.crt
export CORE_PEER_LOCALMSPID=mvd-auto-com
export CORE_PEER_MSPCONFIGPATH=/vars/keyfiles/peerOrganizations/mvd.auto.com/users/Admin@mvd.auto.com/msp
...
jq '.channel_group.groups.Application.groups."mvd-auto-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.126.192","port": 7005}]},"version": "0"}}' autochannel_current_config.json > autochannel_modified_anchor_config.json
